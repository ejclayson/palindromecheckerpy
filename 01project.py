...
def function2(userInput):
    ...
    while userInputLowerCase != "exit":
        ...
        #in case this if condition is false then it will skip the block of code to get executed and will proceed to the "else" statement partnered with this if condition
                    ...
                    if len(userInputLowerCase) > 1:
                        if pattern2 :
                            ...
                            if userInputLowerCase == userInputReversal:
                                ...
                                print("\n" + userInput + " is a not palindrome \nbecause it becomes " + userInputReversal + " when reversed\n")
                                function1();
                        else:
                            print("\nThe string you supplied contains not purely characters. Thanks.\n")
                            function1();
                    else:
                        print("\nThe string you supplied contains only one(1) character. Thanks.\n")
                        function1();
                else:
                    print("\nThe string you supplied contains not purely characters. Thanks.\n")
                    function1();
            ...
            print("\nThe string you supplied is empty. Thanks.\n")
            function1();
    else:
        sys.exit()
